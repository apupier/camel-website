---
title: "How to create a Camel Quarkus project in VS Code"
date: 2024-08-14
authors: [ "apupier" ]
categories: [ "Tooling", "Camel Quarkus" ]
preview: "How to create a Camel Quarkus project in VS Code"
---

There are several ways to create a Camel Quarkus project in VS Code. Let's explore some of them.
...
## Using VS Code language support for Camel

* Open command palette (`Ctrl+Shift+P`)
* Search for the command `Camel: Create a Camel Quarkus project`
* Add routes

## Using VS code Quarkus

* Open command palette (`Ctrl+Shift+P`)
* Search for the command `Quarkus: Generate a Quarkus project`
* Pick `Maven`
* Pick version corresponding to Camel Quarkus
* Pick Java 21
* Provide name you want
* use starter code
* provide name you want
* Add some Camel component for what you want to achieve, for instance camel timer, camel log
* Click `Open in new window` button of the `New project has been generated` notification
* Add your Camel Quarkus dependencies and routes

## Using VS Code toolkit for OpenShift
...
* Click `Create` button in the `From Template Project` panel
* Select Quarkus example
* Click on `Use devfile` button
* Click on `Create component` button
* Add your Camel Quarkus dependencies and routes

## Using VS Code tooling for Maven

* Open command palette (`Ctrl+Shift+P`)
* Search for the command (`Maven: New project...`)
* No archetype
* Add Camel Quarkus dependencies and routes

## Starting from a GitHub repository example
